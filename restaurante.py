...
while True:
    ...
    if escolhaSab == 'BA' and tamanho == 'P':
        ...
        preco = 15.00
        print(f'Você pediu um File de Frango tamanho P total : R$ {preco:.2f}')
        total += preco
    elif escolhaSab == 'FF' and tamanho == 'M':
        preco = 17.00
        print(f'Você pediu um File de Frango tamanho M total : R$ {preco:.2f}')
        total += preco
    elif escolhaSab == 'FF' and tamanho == 'G':
        preco = 21.00
        print(f'Você pediu um File de Frango tamanho G total : R$ {preco:.2f}')
        total += preco
